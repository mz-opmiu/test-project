...
export default {
  ...
  components: { BasePopPersonal, PersonalForm },
  computed: {
    ...mapState(['currentPop'])
  },
  methods: {
    ...mapMutations(['closePop'])
  }
}
</script>
...
.pop-personal {
  ...
  .all-agree {
    ...
    padding: 10px 0;
    margin-bottom: 20px;
    border-bottom: 1px solid #b1a795;
    label {
      margin-left: 10px;
    }
  }
  ...
  input[type='checkbox'] {
    ...
    & ~ span {
      ...
      width: 20px;
      height: 20px;
      @include background($image-url + '/checkbox.png');
